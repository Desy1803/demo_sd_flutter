    ...
    body: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              if (isCategoryMode || widget.isSearchMode)
                IconButton(
              ...
              SizedBox(
                ...
                child: TextField(
                  ...
                  onSubmitted: (query) async {
                    if (query.isNotEmpty) {
                      await _loadCompaniesByCategory(query);
                      setState(() {
                        searchController.clear(); // Cancella il testo
                      });
                    }
                  },
          ...
          const SizedBox(height: 16),
          if (errorMessage != null && companies.isEmpty)
            Center(
              child: Text(
                errorMessage!,
