...
class CompactArticlesPage extends StatefulWidget {
  const CompactArticlesPage({super.key});

  @override
  _CompactArticlesPageState createState() => _CompactArticlesPageState();
}

class _CompactArticlesPageState extends State<CompactArticlesPage> {
